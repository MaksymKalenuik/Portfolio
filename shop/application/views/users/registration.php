    ...
    <div class="container registration-block">
        <div class="block block-user-login col-sm-6 col-xs-12">
            ...
            <div class="block-content">
                <form class="form form-registration" method="post" action="/kaleniyk/shop/users/registration">
        ...
        <div class="block block-new-user col-sm-6 col-xs-12">
            <div class="page-header">
                <h2>Do you have an account? Log In</h2>
            </div>
            <div class="block-content">
                <div class="actions-toolbar">
                    <a href="/kaleniyk/shop/users/index/"
                       class="btn btn-default"><span>Log In</span></a>
                </div>
            </div>
        </div>
