                ...
                <form class="form" method="post" action=""
                    ...
                    <fieldset class="fieldset">
                        <div class="form-group">
                            ...
                            <div class="control">
                                <input type="text" name="product_name" value="<?= $currentProduct['product_name']; ?>"
                                       id="product_name"
                        ...
                        <div class="form-group">
                            ...
                            <div class="control">
                                <input type="text" name="sku" value="<?= $currentProduct['sku']; ?>"
                                       id="sku"
                                       class="form-control input-text">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="control">
                                <input type="number" name="qty" value="<?= $currentProduct['qty']; ?>"
                                       id="qty"
                                       class="form-control input-text">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="control">
                                <textarea name="description" id="description" class="form-control"><?= $currentProduct['description']; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="control">
                                ...
                                <img src="<?= '/kaleniyk/shop/source/images/' . $currentProduct['image']; ?>"
                                     width="50" height="50">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="control">
                                <select name="category_id" id="category_id" class="form-control">
                                    <option value="0" <?= ($currentProduct['category_id'] == 0) ? 'selected' : ''; ?>>
                                        Please, select category...
                                    </option>
                                    <?php if (!empty($categories)) : ?>
                                        <?php foreach ($categories as $category) : ?>
                                            <option value="<?= $category['id']; ?>" <?= ($currentProduct['category_id'] == $category['id']) ? 'selected' : ''; ?>><?= $category['category_name']; ?></option>
                                        <?php endforeach; ?>
                                    <?php endif; ?>
                                </select>
                            </div>
